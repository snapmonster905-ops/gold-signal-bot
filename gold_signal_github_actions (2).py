...
def main():
    ...
    # TEMPORARY TEST LINE - confirms Telegram delivery works.
    # Remove this line after you've verified you received the test message.
    send_telegram_message("✅ Test message - your Gold Signal Bot is connected correctly!")
